...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public interface TabProvider {
         ...
         */
        View createTabView(View container, int position);
    ...
    public SlidingTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.SlidingTabLayout, defStyle, 0);
        customTabLayoutId = a.getResourceId(
                R.styleable.SlidingTabLayout_customTabTextLayoutId, customTabLayoutId);
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (mTabViewLayoutId != NO_ID) {
                ...
                if (tabProvider != null) {
                    tabProvider.createTabView(tabView, i);
                }
            }
    ...
    public void setCustomViewTab(View tabView) {
        tabProvider = new SimpleTabProvider(getContext(), tabView);
    }
     ...
     */
    public void setCustomViewTab(TabProvider provider) {
    ...
    private static class SimpleTabProvider implements TabProvider {
        ...
        private SimpleTabProvider(Context context, View view) {
