...
import com.easyapp.baseproject.lib.base.fragment.BaseDrawerFragment;
import com.easyapp.baseproject.lib.widget.recyclerView.BaseRecyclerViewAdapter;
import com.easyapp.baseproject.lib.widget.recyclerView.EndlessRecyclerOnScrollListener;
 ...
 * 基本的列表fragment
 */
public abstract class BaseRecyclerViewStaggeredFragment extends BaseDrawerFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.easyapp_base_recycler_staggered_view, container, false);
        initView();
        initData();
        init();
        return view;
