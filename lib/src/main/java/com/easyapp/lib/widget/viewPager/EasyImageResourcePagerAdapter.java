...
public class EasyImageResourcePagerAdapter extends PagerAdapter {
    ...
    public static void initial(Activity activity,
                               ...
                               ViewPager viewPager,
                               TabLayout tabLayout) {
        EasyImageResourcePagerAdapter pagerAdapter = new EasyImageResourcePagerAdapter(activity);
...
//                OpenData.OpenTouchImage(activity, arrayList, position);
//            }
//        };
    }

    public void setData(final Collection<? extends Integer> collection) {
        arrayList.clear();
