...
public class PagerBullet extends FrameLayout {
    ...
    public PagerBullet(Context context, ViewPager viewPager, View rootView) {
        super(context);
    ...
    public PagerBullet(Context context, ViewPager viewPager, View rootView, AttributeSet attrs) {
        super(context, attrs);
        initRootView(rootView);
        initViewPager(viewPager);
        init(context);
    ...
    public PagerBullet(Context context, ViewPager viewPager, View rootView, AttributeSet attrs, int defStyleAttr) {
