...
package com.easyapp.sample_ble_spp;
...
import com.easyapp.ble_spp.BluetoothSPP;
import com.easyapp.ble_spp.BluetoothState;
        ...
        btnConnect.setOnClickListener(new OnClickListener(){
            public void onClick(View v){
                if(bt.getServiceState() == BluetoothState.STATE_CONNECTED) {
                    ...
                    Intent intent = new Intent(DeviceListActivity.this, SelectBleActivity.class);
